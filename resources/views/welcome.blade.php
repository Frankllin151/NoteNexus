...
<body class="bg-gray-100">
    ...
    <header class="bg-indigo-600 text-white py-4">
        <div class="container mx-auto flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold">NoteNexus</h1>
                <p class="text-lg">Organize suas ideias e anotações com facilidade e precisão</p>
            </div>
            ...
            <div id="auth-buttons-desktop" class=" repsoivenav  space-x-4">
                @if (Route::has('login'))
                    <nav class="space-x-4 sm:hidden xl:block lg:block">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="bg-white text-indigo-600 py-2 px-4 rounded-lg font-semibold hover:bg-gray-100 transition duration-300">Minhas Anotações</a>
                        @else
                            <a href="{{ route('login') }}" class="bg-white text-indigo-600 py-2 px-4 rounded-lg font-semibold hover:bg-gray-100 transition duration-300">Login</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="bg-white text-indigo-600 py-2 px-4 rounded-lg font-semibold hover:bg-gray-100 transition duration-300">Registrar</a>
                            @endif
                        @endauth
                    </nav>
                @endif
    ...
    <main class="container mx-auto p-6">
        <section class="text-center mb-12">
            <h2 class="text-2xl font-semibold mb-4">Transforme suas ideias em anotações organizadas e detalhadas com facilidade e precisão</h2>
            <p class="text-gray-700 mb-8">Com o NoteNexus, você pode: registrar nomes de livros, detalhar capítulos e adicionar anotações dentro de cada capítulo de forma intuitiva. Ideal para diversas finalidades como criar PDFs com textos para apresentar fatos, relatórios jornalísticos e muito mais.</p>
        </section>
        ...
        <footer class="text-center">
            <h2 class="text-2xl font-semibold mb-4">Experimente o NoteNexus e revolucione a maneira como você organiza e compartilha suas anotações!</h2>
            ...
            @if (Route::has('login'))
                    <nav class="">
                        @auth
                            <a
                            class="bg-indigo-600 text-white py-3 px-6 rounded-lg text-lg font-semibold hover:bg-indigo-400 transition duration-300"
                                href="{{ url('/dashboard') }}"
    ...
    <!-- Script para simular autenticação -->
